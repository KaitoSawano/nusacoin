#!/usr/bin/env python3
# Copyright (c) 2018 The Nusacoin Core developers
...
class IncludeConfTest(NusacoinTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "nusacoin.conf"), "a", encoding='utf8') as f:
