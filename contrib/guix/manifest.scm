...
(define* (make-nusacoin-cross-toolchain target
                                  #:key
...
desirable for building Nusacoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-nusacoin-cross-toolchain "i686-linux-gnu")
       (make-nusacoin-cross-toolchain "x86_64-linux-gnu")
       (make-nusacoin-cross-toolchain "aarch64-linux-gnu")
       (make-nusacoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-nusacoin-cross-toolchain "riscv64-linux-gnu"
