    ...
    while (!fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, FoundBlock().data(block)) && !block.IsNull()) {
            ...
            if (reorg) {
                ...
                // https://github.com/TaobotX11/nusacoin/pull/14711#issuecomment-458342518
        ...
        bool sign)
{
    ...
    int nBytes;
    {
        ...
        txNew.nLockTime = GetLocktimeForNewTransaction(chain(), GetLastBlockHash(), GetLastBlockHeight());
        {
            ...
            // change transaction isn't always pay-to-nusacoin-address
            ...
            if (coin_control.m_feerate && nFeeRateNeeded > *coin_control.m_feerate) {
                error = strprintf(_("Fee rate (%s) is lower than the minimum fee rate setting (%s)"), coin_control.m_feerate->ToString(FeeEstimateMode::NU_VB), nFeeRateNeeded.ToString(FeeEstimateMode::NU_VB));
                return false;
            }
 ...
 * https://nusacointalk.org/?topic=54527, or
 * https://github.com/TaobotX11/nusacoin/pull/1393.
 */
