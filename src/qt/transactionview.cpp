    ...
    QWidget(parent)
{
    ...
    watchOnlyWidget->setStyleSheet("selection-background-color: #3e923e; selection-color: white;");
...
void TransactionView::changedAmount()
{
    ...
    if (NusacoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(NusacoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
