// Copyright (c) 2012-2025 The Nusacoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.nusacoincore.org", "www.nusacoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.nusacoincore.org]", "www.nusacoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.nusacoincore.org:80", "www.nusacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nusacoincore.org]:80", "www.nusacoincore.org", 80));
